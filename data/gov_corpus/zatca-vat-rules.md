---
slug: zatca-vat-rules
title: Value Added Tax — rules and regulations
...
| Details of the good/service | Tax value |
| --- | --- |
...
Filing an annual tax return for establishments whose annual taxable supplies do not exceed 40 million SAR.

##### Simplified Invoicing

Using a simplified tax invoice that includes the issuance date, supplier name and address, item/service description, payment amount, and VAT value.
The invoice must be issued in Arabic and show the total price including VAT. If the total invoice value is less than 1,000 SAR, the VAT registration number of the supplier is not required.

##### Cash Basis Accounting

Using the cash basis accounting method for establishments whose annual supplies (current or previous year) do not exceed 5 million SAR.

#### Does your establishment need specialized support to comply with VAT?

VAT compliance requires fundamental changes to the organization's financial and accounting systems, including:
...
You can access a list of certified accountants and agents via the following links:

Ask professional accountants for support

Tax Agents / Representatives
